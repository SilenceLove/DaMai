...
- (void)setup
{
    ...
    rightView.backgroundColor = [UIColor colorWithHexString:@"#f6f6f6"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView == self.leftView) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"ShowSelectTypeNotification" object:nil];
    }
}
